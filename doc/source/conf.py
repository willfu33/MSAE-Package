...
# -*- coding: utf-8 -*-
#
# plotlinreg documentation build configuration file, created by
...
modindex_common_prefix = ["plotlinreg"]
...
basename = "plotlinreg".replace(" ", "").replace(".", "")
